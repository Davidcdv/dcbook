...
public class CheckoutController {
	...
	public String placeOrder(@Valid Customer customer, BindingResult result, RedirectAttributes redirect) {
		...
		emailService.sendEmail(customer.getEmail(), "bookstore - Order Confirmation", "Your order has been confirmed. for online payments: click this link https://buy.stripe.com/test_3cs7uCesh7hXgwwaEE Your Book would be shipped within 4 working days,Thanks for your Patronage.  ");
